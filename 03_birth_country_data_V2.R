...
bc_2016 <- read_csv("data/Birth country data/birth_country_2016.csv",
                    na = c(":",""))
map_chr(bc_2016, class)

bc_2017 <- read_csv("data/Birth country data/birth_country_2017.csv",
                    na = c(":",""))
map_chr(bc_2017, class)

bc_2018 <- read_csv("data/Birth country data/birth_country_2018.csv",
                    na = c(":",""))
map_chr(bc_2018, class)

bc_2019 <- read_csv("data/Birth country data/birth_country_2019.csv",
                    na = c(":",""))
